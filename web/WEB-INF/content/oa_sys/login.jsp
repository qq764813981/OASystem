        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbar-ex-collapse">
            <ul class="nav navbar-nav navbar-right">
              <li>
                <a href="#"><i class="fa fa-fw fa-share-alt"></i>前台</a>
              </li>
            </ul>
          </div>
        </div>
            ...
            <div class="col-md-12">
              ...
              <div class="panel panel-primary">
                ...
                <div class="panel-body">
                  <p></p>
                  <form role="form" method="post" action="/OASystem/sys/login.action">
                    <div class="form-group">
                      <label class="control-label" for="">用户名</label>
                      <span></span>
                      <input class="form-control input-lg" id="exampleInputEmail1" placeholder="请输入用户名" type="text" name="account">
                    </div>
                    <div class="form-group">
                      <label class="control-label" for="exampleInputPassword1">密码</label>
                      <input class="form-control input-lg" id="exampleInputPassword1" placeholder="请输入密码" type="password" name="password">
                    </div>
                    <br>
                    <center>
                      <button type="submit" class="btn btn-block btn-lg btn-primary">登录</button>&nbsp; &nbsp; &nbsp;</center>
                    <br>
                    <center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <%
                      String loginTip = (String) session.getAttribute("loginTip");
                      if(loginTip != null)
                      {
                        out.write(loginTip);
                      }
