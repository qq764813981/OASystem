...
<html><head>
              ...
              <div class="panel-body">
                <table class="table table-bordered">
                  <tbody>
                    <tr>
                      <td colspan="3">
                        <a href="#" class="btn btn-primary">删除选中任务</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <button class="btn btn-primary" data-toggle="modal" data-target="#addPrjTask">新增任务</button>
                      </td>
                      <td></td>
                      <td></td>
                      <td colspan="2s"></td>
                    ...
                    <tr>
                      ...
                      <td>未选中/已选中/已完成</td>
                      <td colspan="2">&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="#" class="btn btn-primary">确认完成</a>&nbsp;&nbsp;&nbsp;
    ...
    <br>
    <br>
    <div class="modal fade" id="addPrjTask" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="form-group">
                ...
                <input class="form-control input-lg" placeholder="输入任务名" type="text">
              </div>
              <div class="form-group">
                <label class="control-label">期限</label>
                <input class="form-control input-lg" placeholder="输入期限" type="text" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})">
              </div>
              <div class="form-group">
                <label class="control-label" for="exampleInputPassword1">任务内容及要求</label>
                <textarea rows="20" class="form-control" placeholder="输入内容..." id="message" name="Content" data-validation-required-message=""></textarea>
              </div>
              <div class="form-group">
                <label class="control-label">任务积分奖励</label>
                <input class="form-control input-lg" placeholder="输入任务积分" type="number">
              </div>
            </div>
