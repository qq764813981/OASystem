                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="3">
                                                <form class="form-inline">
                                                    <div class="form-group">
                                                        <input class="form-control" id="exampleInputEmail1" placeholder="请输入用户名" type="text">
                                                    </div>&nbsp;&nbsp;&nbsp;
                                                    <div class="form-group">
                                                        <button type="submit" class="btn btn-block btn-primary">&nbsp;&nbsp;查&nbsp;&nbsp;&nbsp;&nbsp;询&nbsp;&nbsp;</button>
                                                    </div>
                                                </form>
                                            </td>
                                            <td></td>
                                            <td>
                                                <button class="btn btn-primary" data-toggle="modal" data-target="#addUser">新增</button>
                                            </td>
                                            <td>
                                            ...
                                            <td colspan="2s">
                                                <form class="form-inline">
                                                    <div class="form-group">
                                                        <input class="form-control" id="exampleInputEmail1" type="file">
                                                    </div>&nbsp;&nbsp;&nbsp;
                                                    <div class="form-group">
                                                        <button type="submit" class="btn btn-block btn-primary">&nbsp;&nbsp;导&nbsp;&nbsp;&nbsp;&nbsp;入&nbsp;&nbsp;</button>
                                                    </div>
                                                </form>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>管理员</td>
                                            <td colspan="2">&nbsp;
                                                <button class="btn btn-primary" data-toggle="modal" data-target="#editUser">修改</button>&nbsp;&nbsp;&nbsp;&nbsp;
                                                <a href="#" class="btn btn-primary">删除</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control input-lg" placeholder="输入用户名" type="text">
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label">帐号</label>
                                                        <input class="form-control input-lg" placeholder="输入帐号" type="text">
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label">选择头像</label>
                                                        <input class="form-control input-lg" placeholder="输入帐号" type="file">
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label">性别</label>
                                                        <label class="checkbox-inline">
                                                            <input type="radio" name="optionsRadiosinline" id="optionsRadios3" value="option1" checked="">男</label>
                                                        <label class="checkbox-inline">
                                                            <input type="radio" name="optionsRadiosinline" id="optionsRadios4" value="option2">女</label>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label">电话</label>
                                                        <input class="form-control input-lg" placeholder="输入电话" type="text">
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label">电子邮箱</label>
                                                        <input class="form-control input-lg" placeholder="输入电子邮箱" type="text">
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label">生日</label>
                                                        <input class="form-control input-lg" placeholder="输入生日" type="text" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})">
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label">身份</label>
                                                        <label class="checkbox-inline">
                                                            <input type="radio" name="optionsRadiosinline" id="optionsRadios5" value="option1" checked="">普通用户</label>
                                                        <label class="checkbox-inline">
                                                            <input type="radio" name="optionsRadiosinline" id="optionsRadios6" value="option2">管理员</label>
                                                    </div>
                                                </div>
